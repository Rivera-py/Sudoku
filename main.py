...
modded_solve3(sudoku)
display_current(sudoku)
# Uncomment below if still unsolved
'''
expanded_x_wing_rows(sudoku)
modded_solve3(sudoku)
expanded_x_wing_cols(sudoku)
modded_solve3(sudoku)
display_current(sudoku)
'''
# Uncomment if still unsolved (untested)